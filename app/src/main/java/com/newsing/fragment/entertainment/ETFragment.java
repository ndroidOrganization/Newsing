package com.newsing.fragment.entertainment;
...
public class ETFragment extends BaseFragment {
    private final static String TABNAME = "娱乐";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_entertain,container,false);
        recyclerView = (RecyclerView) view.findViewById(R.id.entertain_content);
        ...
        async(ConstValue.ALIAPI.ENTERTAINMENT);
        return view;
    }
